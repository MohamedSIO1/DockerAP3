...
class getApiPlatform_Openapi_OptionsService extends App_KernelProdContainer
{
    ...
    {
        return $container->privates['api_platform.openapi.options'] = new \ApiPlatform\OpenApi\Options('A4S • API', '', '1.0.0', false, 'oauth2', 'application', '', '', '', [], [], NULL, NULL, NULL, NULL, NULL, NULL);
    }
}
