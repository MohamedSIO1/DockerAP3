...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\API\\LoginAPIController' => 'getLoginAPIControllerService',
            'App\\Controller\\API\\ProductAPIController' => 'getProductAPIControllerService',
            'App\\Controller\\Client\\CartController' => 'getCartControllerService',
            'App\\Controller\\Client\\CategoryController' => 'getCategoryControllerService',
            'App\\Controller\\Client\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\Client\\ProductController' => 'getProductControllerService',
            'App\\Controller\\Client\\ProfilController' => 'getProfilControllerService',
            'App\\Controller\\Client\\RegistrationController' => 'getRegistrationControllerService',
            'App\\Controller\\Logistics\\AccountController' => 'getAccountControllerService',
            'App\\Controller\\Logistics\\DashboardController' => 'getDashboardControllerService',
            'App\\Controller\\Logistics\\HomeController' => 'getHomeController2Service',
            'App\\Controller\\Logistics\\ProductController' => 'getProductController2Service',
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AdhbNe2RgO', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\BuildingRepository' => ['privates', 'App\\Repository\\BuildingRepository', 'getBuildingRepositoryService', true],
            'App\\Repository\\CategoryRepository' => ['privates', 'App\\Repository\\CategoryRepository', 'getCategoryRepositoryService', true],
            'App\\Repository\\CredentialRepository' => ['privates', 'App\\Repository\\CredentialRepository', 'getCredentialRepositoryService', true],
            ...
            'App\\Repository\\OrderRankRepository' => ['privates', 'App\\Repository\\OrderRankRepository', 'getOrderRankRepositoryService', true],
            'App\\Repository\\OrderStateRepository' => ['privates', 'App\\Repository\\OrderStateRepository', 'getOrderStateRepositoryService', true],
            'App\\Repository\\OrderUserRepository' => ['privates', 'App\\Repository\\OrderUserRepository', 'getOrderUserRepositoryService', true],
            'App\\Repository\\ProductImgRepository' => ['privates', 'App\\Repository\\ProductImgRepository', 'getProductImgRepositoryService', true],
            ...
            'App\\Repository\\ShelfRepository' => ['privates', 'App\\Repository\\ShelfRepository', 'getShelfRepositoryService', true],
            'App\\Repository\\StockShelfRepository' => ['privates', 'App\\Repository\\StockShelfRepository', 'getStockShelfRepositoryService', true],
            'App\\Repository\\StockStoreRepository' => ['privates', 'App\\Repository\\StockStoreRepository', 'getStockStoreRepositoryService', true],
            'App\\Repository\\StoreRepository' => ['privates', 'App\\Repository\\StoreRepository', 'getStoreRepositoryService', true],
            ...
            'App\\Repository\\WarehouseRepository' => ['privates', 'App\\Repository\\WarehouseRepository', 'getWarehouseRepositoryService', true],
            'App\\Repository\\WayRepository' => ['privates', 'App\\Repository\\WayRepository', 'getWayRepositoryService', true],
        ], [
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6n0+RfVr9S', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qxqKmeHCVJ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AeeyhhpN1G', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('ciHh6ukWNm', 0, $container->getParameter('container.build_id'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3O4NEfQTre', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5C9GQKi7CT', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J5mE-vptT6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8yi0lN1dH-', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        $container->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nEMdHlDbWd', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false)));
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uDONrtSh1Q', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getSerializerService($container)
    {
        ...
        $i = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $g, $a)], [$h]))));
        ...
        $o = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($c, $d, $k, $e, $l, $f, $g, $j, $m, [], $n);
        $p = new \ApiPlatform\Serializer\ItemNormalizer($d, $k, $e, $l, $g, $j, $m, NULL, $c, $n);
        $q = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($m);
        $r = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($m, $j, $g, $a, $q, NULL);
        $s = new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL);

        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($g), $i, $i, new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $j), new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($b, [], $j), new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $j), $i, new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($o, $j), new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($c, $d, $k, $l, $b, $j), new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($c, $e, $b), new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($b, false, []), new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $j), new \ApiPlatform\Problem\Serializer\ErrorNormalizer(false, []), new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false, translator: ($container->services['translator'] ?? self::getTranslatorService($container))), new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $o, $p, new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $j), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($m, $j, $a, $q, NULL)), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($f, $l, $e, NULL), 'page', 'pagination', $c, $g), $c, $l, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], []))), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($r, $e, $f), $r], [new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $h, $s, new \Symfony\Component\Serializer\Encoder\CsvEncoder(), new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $s), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    private $loadedDynamicParameters = [
        ...
        'app.host.client' => false,
        'app.host.logistics' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'app.host.client' => $container->getEnv('APP_HOST_CLIENT'),
            'app.host.logistics' => $container->getEnv('APP_HOST_LOGISTICS'),
